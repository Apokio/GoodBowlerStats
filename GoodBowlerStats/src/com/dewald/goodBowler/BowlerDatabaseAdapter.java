...
public class BowlerDatabaseAdapter {
	...
	public static final String LEAGUE_NIGHT_TABLE = "leaguenight";
	...
	public Cursor fetchScoresForBowlerLeagueDate(String bowler, String league, String date) {
		...
		return database.query(LEAGUE_NIGHT_TABLE, new String[] { KEY_GAME_ONE_SCORE, KEY_GAME_TWO_SCORE, KEY_GAME_THREE_SCORE, KEY_SERIES_SCORE }, 
	...
	public Cursor fetchListGamesData(String bowler, String date1, String date2){
		...
		return database.query(LEAGUE_NIGHT_TABLE, new String[] {KEY_GAME_ONE_SCORE, KEY_GAME_TWO_SCORE, KEY_GAME_THREE_SCORE, KEY_DATE},
	...
	public Cursor fetchGameData(String bowler, String league, String date1, String date2){
		...
		if(league.contentEquals("%")){
			query = database.query(LEAGUE_NIGHT_TABLE, new String[] {KEY_GAME_ONE_SCORE, KEY_GAME_TWO_SCORE, KEY_GAME_THREE_SCORE, KEY_SERIES_SCORE}, 
			...
			query = database.query(LEAGUE_NIGHT_TABLE, new String[] {KEY_GAME_ONE_SCORE, KEY_GAME_TWO_SCORE, KEY_GAME_THREE_SCORE, KEY_SERIES_SCORE}, 
					...
					null, null, null, null);
					Log.v("gameData 2", KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) +" AND " + KEY_LEAGUE_NAME + "=" + DatabaseUtils.sqlEscapeString(league) + " AND " + KEY_DATE + " BETWEEN '" + date1 + "' AND '" + date2 +"'");
		}
	...
	public Cursor fetchStrikeData(String bowler, String league, String date1, String date2){
		...
		if(league.contentEquals("%")){
			query = database.query(GAME_TABLE, STRIKE_KEY, 
					KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) +" AND " + KEY_LEAGUE_NAME + " LIKE " + DatabaseUtils.sqlEscapeString(league) + " AND " + KEY_DATE + " BETWEEN '" + date1 + "' AND '" + date2 +"'",
					null, null, null, null);
					Log.v("strikedata 1", KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) +" AND " + KEY_LEAGUE_NAME + " LIKE " + DatabaseUtils.sqlEscapeString(league) + " AND " + KEY_DATE + " BETWEEN '" + date1 + "' AND '" + date2 +"'");
		}else{
			query = database.query(GAME_TABLE, STRIKE_KEY, 
					KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) +" AND " + KEY_LEAGUE_NAME + "=" + DatabaseUtils.sqlEscapeString(league) + " AND " + KEY_DATE + " BETWEEN '" + date1 + "' AND '" + date2 +"'",
					null, null, null, null);
					Log.v("strikedata 2", KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) +" AND " + KEY_LEAGUE_NAME + "=" + DatabaseUtils.sqlEscapeString(league) + " AND " + KEY_DATE + " BETWEEN '" + date1 + "' AND '" + date2 +"'");
		}
	...
	public long createGame(String bowlerName, String leagueName, String date, String gameNumber, String[] pins, String[] ball, String[] mark, String[] feet) {
		ContentValues initialValues = createGameContentValues(bowlerName, leagueName, date, gameNumber, pins, ball, mark, feet);
		return database.insert(GAME_TABLE, null, initialValues);
	}
	
	public boolean checkGameRecords(String bowler, String league, String date, String gameNumber){
	...
	//database query that checks to see to see if records for a leaguenight already exist
	public boolean checkLeagueNightRecords(String bowler, String league, String date){
		boolean exists = false;
		Cursor c = database.query(LEAGUE_NIGHT_TABLE, new String[] { KEY_BOWLER_NAME, KEY_LEAGUE_NAME, KEY_DATE}, KEY_BOWLER_NAME + "=" + DatabaseUtils.sqlEscapeString(bowler) 
	...
	private ContentValues createGameContentValues(String bowlerName, String leagueName, String date, String gameNumber, String[] pins, String[] ball, String[] mark, String[] feet) {
		ContentValues values = new ContentValues();
		values.put(KEY_BOWLER_NAME, bowlerName);
		values.put(KEY_LEAGUE_NAME, leagueName);
		values.put(KEY_DATE, date);
