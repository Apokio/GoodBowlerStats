...
public class ScoreCardActivity extends Activity implements OnClickListener, OnItemSelectedListener, OnSeekBarChangeListener {
	...
	public void finish(){
		if(checkDataEntered()){
			if(mDbHelper.checkGameRecords(bowler, league, date, gameNumber)){
				mDbHelper.deleteGame(bowler, league, date, gameNumber);
			}
			mDbHelper.createGame(bowler, league, date, gameNumber, scoreArray, ballArray, markArray, feetArray);
